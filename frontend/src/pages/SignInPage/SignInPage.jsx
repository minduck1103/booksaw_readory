...
const SignInPage = () => {
  ...
  const handleNavigateSignUp = () => {
    navigate('/sign-up'); // Chuyển hướng đến trang sign-up
  };
    ...
    <div style={{display:'flex', alignItems:'center', justifyContent:'center',background:'rgba(0,0,0,0.53)', height:'100vh'}}>
      ...
      <WrapperContainerLeft>
        ...
        <div style={{ marginLeft: '-32px', marginRight: 'auto', width: '100%' }}>
          <InputForm style={{marginBottom:'10px'}} placeholer="nguyenvana@gmail.com" value={email} onChange={handleOnchangeEmail}/>
        ...
        <p>
          Chưa có tài khoản? <WrapperTextLight onClick={handleNavigateSignUp} style={{cursor:'pointer'}}>Tạo tài khoản</WrapperTextLight>
        </p>
      </WrapperContainerLeft>
